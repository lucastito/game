...
//		Tantra, Sluis, Kashyyyk, Alaris_Prime};
	...
	private void initializePlanets() {
		...
		planet = new Planet((short) 1, "Trandosha", (short)10, (short)10, "image/planets/Trandosha.png");
		...
		planet = new Planet((short) 2, "Muunlist", (short)110, (short)10, "image/planets/Muunlist.png");
		...
		planet = new Planet((short) 3, "Bakura", (short)215, (short)30, "image/planets/Bakura.png");
		planet.addInternalBorder(new Border("Bakura", "Naboo"));
		planet.addExternalBorder(new Border("Bakura", "Sarapin"));
		addPlanet(planet);
		
		planet = new Planet((short) 4, "Calamari", (short)18, (short)110, "image/planets/Calamari.png");
		...
		planet = new Planet((short) 5, "Naboo", (short)135, (short)105, "image/planets/Naboo.png");
		...
		planet = new Planet((short) 6, "Dantooine", (short)70, (short)193, "image/planets/Dantooine.png");
		...
		planet = new Planet((short) 11, "Yavin IV", (short)1115, (short)10, "image/planets/Yavin_IV.png");
		planet.addInternalBorder(new Border("Yavin IV", "Corellia"));
		planet.addInternalBorder(new Border("Yavin IV", "Nelvaan"));
		addPlanet(planet);
		
		planet = new Planet((short) 12, "Kamino", (short)1270, (short)20, "image/planets/Kamino.png");
		planet.addInternalBorder(new Border("Kamino", "Corellia"));
		planet.addInternalBorder(new Border("Kamino", "Ando"));
		addPlanet(planet);
		
		planet = new Planet((short) 13, "Corellia", (short)1200, (short)60, "image/planets/Corellia.png");
		...
		planet = new Planet((short) 14, "Nelvaan", (short)1125, (short)90, "image/planets/Nelvaan.png");
		...
		planet = new Planet((short) 15, "Rhen Var", (short)1265, (short)120, "image/planets/Rhen_Var.png");
		...
		planet = new Planet((short) 16, "Ando", (short)1195, (short)155, "image/planets/Ando.png");
		...
		planet = new Planet((short) 17, "Tynna", (short)130, (short)350, "image/planets/Tynna.png");
		planet.addExternalBorder(new Border("Tynna", "Dantooine"));
		planet.addExternalBorder(new Border("Tynna", "Geonosis"));
		addPlanet(planet);
		
		planet = new Planet((short) 18, "Sy Myrth", (short)1130, (short)300, "image/planets/Sy_Myrth.png");
		planet.addExternalBorder(new Border("Sy Myrth", "Ando"));
		planet.addExternalBorder(new Border("Sy Myrth", "Danjar"));
		addPlanet(planet);
		
		planet = new Planet((short) 19, "Geonosis", (short)30, (short)500, "image/planets/Geonosis.png");
		...
		planet = new Planet((short) 20, "Mustafar", (short)5, (short)580, "image/planets/Mustafar.png");
		...
		planet = new Planet((short) 21, "Yag'Dhul", (short)85, (short)570, "image/planets/Yag'Dhul.png");
		...
		planet = new Planet((short) 22, "Hypori", (short)180, (short)575, "image/planets/Hypori.png");
		...
		planet = new Planet((short) 23, "Nivek", (short)50, (short) 650, "image/planets/Nivek.png");
		planet.addInternalBorder(new Border("Nivek", "Tatooine"));
		planet.addExternalBorder(new Border("Nivek", "Naboo"));
		addPlanet(planet);
		
		planet = new Planet((short) 24, "Tatooine", (short)140, (short)645, "image/planets/Tatooine.png");
		...
		planet = new Planet((short) 29, "Elrood", (short)1105, (short)540, "image/planets/Elrood.png");
		...
		planet = new Planet((short) 30, "Danjar", (short)1175, (short)550, "image/planets/Danjar.png");
		...
		planet = new Planet((short) 31, "Tantra", (short)1235, (short)520, "image/planets/Tantra.png");
		planet.addInternalBorder(new Border("Tantra", "Alaris Prime"));
		planet.addInternalBorder(new Border("Tantra", "Danjar"));
		addPlanet(planet);
		
		planet = new Planet((short) 32, "Sluis", (short)1085, (short)630, "image/planets/Sluis.png");
		...
		planet = new Planet((short) 33, "Kashyyyk", (short)1180, (short)650, "image/planets/Kashyyyk.png");
		...
		planet = new Planet((short) 34, "Alaris Prime", (short)1270, (short)590, "image/planets/Alaris_Prime.png");
